...
<head>
	...
	if ($context['page_title_html_safe'] == 'Jazz Trumpet Forum - Index') 
   echo '
    <title>Jazz Trumpet Forum - Music videos, loving music, jazz questions, websites, musicians, tunes, and more!</title>
	<meta name="description" content="The Jazz Trumpet Forum is all about music in general, videos, jazz questions, websites, musicians, tunes, 
...
// Bad Behavior End
	...
	<link rel="shortcut icon" href="http://www.jazztrumpetlicks.com/favicon.ico" />';
...
<div id="top">
<div class="thetop">
<table width="100%" align="center" border="0" cellspacing="2" cellpadding="2" summary="table for header">
  <tr>
    <td class="gsearch">
<form action="http://jazztrumpetlicks.com/google-search/" id="cse-search-box">
  <div>
...
<script type="text/javascript" src="http://www.google.com/cse/brand?form=cse-search-box&amp;lang=en"></script>
    ...
    <td class="navr"><ul class="menu">
      <li><a href="http://jazztrumpetlicks.com/">Home</a></li>
      <li><a href="http://jazztrumpetlicks.com/resources/">Resources</a></li>
<li class="current_page_item"><a href="http://jazztrumpetlicks.com/forum/">Forum</a></li>
</ul></td>
  </tr>
</table>
</div>
...
<div id="splash">
  <h1><a href="http://jazztrumpetlicks.com/forum/">
    ' . $context['forum_name'] . '
    </a></h1>
</div>
<div class="bodycontainer">
<div id="wrapper" style="width:970px;">' : '', '
		...
		if (!empty($settings['enable_news']))
			echo '
				...
				if ($context['user']['is_guest'])
					echo 'Register to post ad free!';
				else
					echo 'Share your favorite Jazz Videos, post some today!';

		echo '
		<br /><div style="padding-top:10px;" class="fb-like" data-href="https://www.facebook.com/jazztrumpetlicks" data-width="200" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
			</div>
		</div>
		<br class="clear" />';
...
if ($context['user']['is_guest'])
		echo '
		<p align="center" style="padding-top:20px;margin-bottom:20px;"><script type="text/javascript"><!--
google_ad_client = "pub-0372492470050030";
/* 728x90, Increase Earnings bottom banner created 12/12/08 */
google_ad_slot = "6231773133";
google_ad_width = 728;
google_ad_height = 90;
//-->
</script>
...
if ($context['user']['is_guest'])
	echo '
	<p align="center" style="padding-top:15px;"><script type="text/javascript"><!--
google_ad_client = "pub-0372492470050030";
/* 728x90, Increase Earnings bottom banner created 12/12/08 */
google_ad_slot = "6231773133";
google_ad_width = 728;
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			...
			<li class="copyright"><a href="http://www.omernarin.com" target="_blank" class="new_win" title="Web Tasarım Kayseri"><span>Extreme Red Theme</span></a> - <a href="http://www.omernarin.com" target="_blank" class="new_win" title="web tasarım kayseri"><span>Smf</span></a> modified by <a href="http://www.signupandmakemoney.com" target="_blank">Signupandmakemoney, LLC</a> see <a href="http://jazztrumpetlicks.com/disclosures/">Disclosures</a></li>
		...
		</ul><div align="center"><div id="google_translate_element"></div><script>
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-3173227-6");
...
function theme_linktree($force_show = false)
{
	...
	foreach ($context['linktree'] as $link_num => $tree)
	{
		...
		echo $settings['linktree_link'] && isset($tree['url']) ? '
				<a href="' . $tree['url'] . '"><span><b>' . $tree['name'] . '</b></span></a>' : '<span><b>' . $tree['name'] .'</b></span>';
